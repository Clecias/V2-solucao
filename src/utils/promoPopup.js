const STORAGE_KEY = 'promo_60off_state_v3';
...
const injectStyles = () => {
  ...
  style.textContent = PROMO_STYLES;
...
const injectMarkup = () => {
  ...
  wrapper.innerHTML = PROMO_MARKUP;
  document.body.appendChild(wrapper);
};

export const initPromoPopup = () => {
  ...
  if (!overlay || !closeBtn || !mini || !miniBtn || !copyBtn || !codeEl) return;
